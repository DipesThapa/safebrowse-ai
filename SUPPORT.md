...
Safeguard is maintained publicly on GitHub. The table below outlines how to reach us for different scenarios.

| Need | Channel | Expectations |
| --- | --- | --- |
...
- Regular maintenance releases no less than once per quarter.
- Hotfixes for critical blocking issues (e.g., extension fails to load) within 3 business days of confirmation.
- Documentation updates shipped alongside significant UI/behaviour changes.

## Self-service resources

- [README](README.md) — product overview, installation, and roadmap
- [PRIVACY](PRIVACY.md) — privacy and data-handling commitments
- [SECURITY](SECURITY.md) — coordinated disclosure policy
- [docs/WEBSTORE.md](docs/WEBSTORE.md) — Chrome Web Store publishing checklist

Need a bespoke support agreement? Fork the repository or open a discussion to coordinate sponsorship/commercial support.
